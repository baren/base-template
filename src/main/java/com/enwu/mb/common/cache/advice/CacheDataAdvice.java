package com.enwu.mb.common.cache.advice;

import com.enwu.mb.common.cache.ICacheClient;
import com.enwu.mb.common.cache.ICacheManager;
import com.enwu.mb.common.cache.annoation.CacheData;

import com.enwu.mb.common.cache.except.AnnotationAsignException;
...
public class CacheDataAdvice {
    ...
    @Pointcut("@annotation(com.enwu.mb.common.cache.annoation.CacheData)")
